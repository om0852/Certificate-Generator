...
export default function Page() {
  ...
  const addProjectInFolder =async(cercertificateId)=>{
      const res1 = await fetch(
        `http://localhost:3000/api/dashboard/folder/add`,
        {
          method: "POST",
          headers: {
            Accept: "application/json",
          ...
          body: JSON.stringify({ id: "om",certificateId:certificateId }),
        }
      );
      const response = await res1.json();
      if (response.status == 404) {
        ...
        <div className="w" style={{ background: "white", overflow: "hidden" }}>
          <div style={{ width: "95%", height: "100%", margin: "auto" }}>
            ...
            <div className="w h-5">
              ...
              <div
                style={{ width: "100%", overflow: "hidden", height: "45vh" }}
              >
                <div
                  style={{
                    height: "45vh",
