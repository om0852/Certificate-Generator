...
<div>
        ...
        <div style={{height:"12vh"}}  onClick={(e)=>{setMenu(true);setMenuData("My Graphics")}} className="sidebar-icon">   
...
<span style={{textAlign:"center"}}>        My Graphics</span>
        </div>
      ...
      <div onClick={uploadCertificateTemplate} className="sidebar-icon">
